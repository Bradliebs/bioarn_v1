"""Phase 3b local SSL repair. Fixes γ=10 feature collapse and spatial features/probe mismatch from Phase 3."""
...
def _write_decision(
    *,
    ...
    path = ROOT / ".squad" / "decisions" / "inbox" / "tank-local-ssl-3b.md"
